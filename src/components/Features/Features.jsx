      ...
      <div>
        ...
        <div className={css.vehicleDetails}>
          ...
          <ul className={css.details}>
            <li>
              <span>Form</span> {capitalizeFirstLetter(camper.form)}
            </li>
            <li>
              <span>Length</span> {camper.length.slice(0, -1)} m
            </li>
            <li>
              <span>Width</span> {camper.width.slice(0, -1)} m
            </li>
            <li>
              <span>Height</span> {camper.height.slice(0, -1)} m
            </li>
            <li>
              <span>Tank</span> {camper.tank.slice(0, -1)} l
            </li>
            <li>
